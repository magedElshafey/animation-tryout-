...
//             <div className="btns flex justify-start items-center mt-5 gap-1 group w-fit">
//               <button className="w-14 h-14 rounded-full bg-[#006450] text-white text-3xl transition-transform duration-500 group-hover:translate-x-64">
...
//         <h1
//           className="hidden md:block absolute top-20 left-5 md:left-[30%] text-left text-4xl md:text-7xl lg:text-[5rem] xl:text-8xl font-light leading-tight text-black z-40 mix-blend-overlay"
